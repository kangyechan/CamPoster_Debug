...
class MyAlarmTagPage extends StatefulWidget {
  List<String> alarmTagList;

  MyAlarmTagPage({Key key, @required this.alarmTagList}) : super(key: key);

  @override
  _MyAlarmTagPageState createState() =>
      _MyAlarmTagPageState(alarmTagList: alarmTagList);
}

class _MyAlarmTagPageState extends State<MyAlarmTagPage> {
  List<String> alarmTagList;
  ...
  _MyAlarmTagPageState({Key key, @required this.alarmTagList});
